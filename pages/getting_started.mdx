import { InstallLink } from '../components/VsCodeLink';
...
<InstallLink target={'vscode'}>Click here to install the extension in Vs-Code</InstallLink>
<InstallLink target={'vscode'}>![testimage](/images/gettingStarted/ExtensionSearch.png)</InstallLink>
