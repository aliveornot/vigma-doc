...
[Click here to install](vscode:extension/n3rds-inc.rnflow) the extension in Vs-Code.
[![testimage](/images/gettingStarted/ExtensionSearch.png)](vscode:extension/n3rds-inc.rnflow)

If you can NOT run VS-Code right now, you can visit microsoft [marketplace](https://marketplace.visualstudio.com/items?itemName=n3rds-inc.rnflow) instead.
