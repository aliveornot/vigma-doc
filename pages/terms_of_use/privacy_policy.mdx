...
This Privacy Policy describes how Nerds Inc. ("us", "we", or "our") collects, uses, and discloses information in relation to users of the Vigma RN VS Code extension ("Vigma RN", "extension", "service").
